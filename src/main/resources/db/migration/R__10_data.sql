...
VALUES
(15, 2, '2026-07-02', 'T1', '업무 스트레스 상담', '충분한 휴식을 권장함.', 'FINISHED', '2026-07-02 10:00:00', '2026-06-25 00:00:00'),
(8, 3, '2026-07-02', 'T2', '근골격계 통증 상담', '파스 처방 및 스트레칭 안내.', 'FINISHED', '2026-07-02 11:00:00', '2026-06-26 00:00:00'),
(12, NULL, '2026-07-03', 'T3', '개인 사유로 인한 취소', NULL, 'CANCELED', NULL, '2026-06-28 00:00:00'),
(12, 2, '2026-07-03', 'T3', '수면 장애 상담', '수면 패턴 교정 안내.', 'FINISHED', '2026-07-03 14:00:00', '2026-06-29 00:00:00'),
(19, 3, '2026-07-07', 'T1', '혈압 점검', '상담 미진행.', 'EXPIRED', '2026-07-07 10:00:00', '2026-07-01 00:00:00'),
(22, 2, '2026-07-08', 'T4', '금연 상담', '니코틴 패치 안내.', 'FINISHED', '2026-07-08 15:00:00', '2026-07-02 00:00:00'),
(5, 3, '2026-07-10', 'T2', '정서적 지원 요청', '사내 심리상담 프로그램 연계.', 'FINISHED', '2026-07-10 11:00:00', '2026-07-04 00:00:00'),
(14, NULL, '2026-07-14', 'T1', '일정 변경으로 인한 취소', NULL, 'CANCELED', NULL, '2026-07-05 00:00:00'),
(14, 2, '2026-07-14', 'T1', '허리 통증 관리', '바른 자세 유지 강조.', 'FINISHED', '2026-07-14 10:00:00', '2026-07-08 00:00:00'),
(31, 3, '2026-07-15', 'T3', '체중 조절 상담', '식단 조절 및 유산소 운동 권장.', 'FINISHED', '2026-07-15 14:00:00', '2026-07-10 00:00:00'),
(7, 2, '2026-07-17', 'T5', '업무 피로 누적', '휴가 사용 권장.', 'FINISHED', '2026-07-17 16:00:00', '2026-07-11 00:00:00'),
(18, 3, '2026-07-21', 'T2', '시력 저하 및 안구건조증', '인공눈물 처방 및 휴식 안내.', 'FINISHED', '2026-07-21 11:00:00', '2026-07-15 00:00:00'),
(25, NULL, '2026-07-22', 'T4', '개인 사정 취소', NULL, 'CANCELED', NULL, '2026-07-16 00:00:00'),
(25, 2, '2026-07-22', 'T4', '소화불량 상담', '규칙적인 식습관 유지.', 'FINISHED', '2026-07-22 15:00:00', '2026-07-17 00:00:00'),
(33, 3, '2026-07-24', 'T1', '스트레스 관리', '명상 앱 활용 추천.', 'FINISHED', '2026-07-24 10:00:00', '2026-07-18 00:00:00'),
(9, 2, '2026-07-28', 'T3', '종합건강검진 결과 상담', '추가 정밀 검진 권유.', 'FINISHED', '2026-07-28 14:00:00', '2026-07-22 00:00:00'),
(4, 3, '2026-07-30', 'T6', '어깨 통증 완화 방법', '온찜질 및 스트레칭 병행.', 'FINISHED', '2026-07-30 17:00:00', '2026-07-25 00:00:00'),

(11, 2, '2026-08-04', 'T1', '두통 및 피로 상담', '수면 환경 개선.', 'FINISHED', '2026-08-04 10:00:00', '2026-07-29 00:00:00'),
(16, 3, '2026-08-05', 'T2', '목 디스크 초기 증상', '모니터 높이 조절 안내.', 'FINISHED', '2026-08-05 11:00:00', '2026-07-30 00:00:00'),
(21, NULL, '2026-08-06', 'T3', '단순 변심 취소', NULL, 'CANCELED', NULL, '2026-08-01 00:00:00'),
(21, 2, '2026-08-06', 'T3', '혈당 관리 상담', '당류 섭취 줄이기.', 'FINISHED', '2026-08-06 14:00:00', '2026-08-02 00:00:00'),
(28, 3, '2026-08-11', 'T4', '업무 의욕 저하', '상담 미진행.', 'EXPIRED', '2026-08-11 15:00:00', '2026-08-05 00:00:00'),
(23, 3, '2026-08-12', 'T3', '최근 혈압이 높아져 생활습관 점검이 필요합니다.', '상담 미진행.', 'EXPIRED', '2026-08-12 13:00:00', '2026-08-09 00:00:00'),
(34, 2, '2026-08-13', 'T1', '알레르기 비염 증상 완화', '마스크 착용 및 환기 철저.', 'FINISHED', '2026-08-13 10:00:00', '2026-08-08 00:00:00'),
(6, 3, '2026-08-18', 'T2', '체력 저하 상담', '영양제 복용 가이드 제공.', 'FINISHED', '2026-08-18 11:00:00', '2026-08-12 00:00:00'),
(13, NULL, '2026-08-19', 'T5', '출장 일정으로 취소', NULL, 'CANCELED', NULL, '2026-08-13 00:00:00'),
(13, 2, '2026-08-19', 'T5', '손목 터널 증후군 예방', '손목 보호대 착용 권장.', 'FINISHED', '2026-08-19 16:00:00', '2026-08-14 00:00:00'),
(7, 3, '2026-08-21', 'T3', '불규칙한 수면 패턴으로 인한 피로 누적 상담입니다.', '수면 공간에서는 영상 시청을 자제하세요. 근로와 별도로 30분 가량의 산책을 권장합니다.', 'FINISHED', '2026-08-21 13:00:00', '2026-08-24 00:00:00'),
(9, NULL, '2026-08-22', 'T1', '업무 스트레스와 수면 패턴에 대한 상담을 원합니다.', NULL, 'CANCELED', NULL, '2026-08-10 00:00:00'),
(24, 3, '2026-08-22', 'T1', '업무 관련 정서적 어려움에 대한 상담을 원합니다.', '당신의 잘못이 아닙니다. 어려우시겠지만 절대 자책하지 마시고, 해당 부분은 근로자분에게 피해가 가지 않도록 인사권에 전달하도록 하겠습니다.', 'FINISHED', '2026-08-22 10:00:00', '2026-08-10 00:00:00'),
(11, 3, '2026-08-22', 'T5', '장시간 근무로 인한 허리 통증 관리 방법을 알고 싶습니다.', '스트레칭을 자주 해주시고, 현재 상태로는 병원에서 진찰을 받아보시는 것이 좋겠습니다.', 'FINISHED', '2026-08-22 15:00:00', '2026-08-21 00:00:00'),
(9, 3, '2026-08-23', 'T1', '업무 스트레스와 수면 패턴에 대한 상담을 원합니다.', '취미 활동을 가져보세요. 수면 공간에서는 영상 시청을 자제하세요.', 'FINISHED', '2026-08-23 10:00:00', '2026-08-27 00:00:00'),
(20, 2, '2026-08-23', 'T3', '불규칙한 수면 패턴으로 인한 피로 누적 상담입니다.', '상담 미진행.', 'EXPIRED', '2026-08-23 13:00:00', '2026-08-19 00:00:00'),
(7, 3, '2026-08-25', 'T2', '금연 프로그램 참여 관련 상담을 요청합니다.', '상담 미진행.', 'EXPIRED', '2026-08-25 10:00:00', '2026-08-14 00:00:00'),
(5, 3, '2026-08-28', 'T1', '불규칙한 수면 패턴으로 인한 피로 누적 상담입니다.', '수면 공간에서는 영상 시청을 자제하세요. 근로와 별도로 30분 가량의 산책을 권장합니다.', 'FINISHED', '2026-08-28 11:00:00', '2026-08-30 00:00:00'),

(29, 3, '2026-09-01', 'T2', '불규칙한 수면 패턴으로 인한 피로 누적 상담입니다.', '수면 공간에서는 영상 시청을 자제하세요. 근로와 별도로 30분 가량의 산책을 권장합니다.', 'FINISHED', '2026-09-01 10:00:00', '2026-08-09 00:00:00'),
(12, NULL, '2026-09-01', 'T4', '업무 스트레스와 수면 패턴에 대한 상담을 원합니다.', NULL, 'CANCELED', NULL, '2026-08-10 00:00:00'),
(20, 2, '2026-09-01', 'T3', '업무 스트레스와 수면 패턴에 대한 상담을 원합니다.', '업무 스트레스와 수면 패턴에 대한 상담을 원합니다.', 'FINISHED', '2026-08-24 13:00:00', '2026-09-01 00:00:00'),
(27, 2, '2026-09-02', 'T3', '체중 증가로 인한 건강 관리 방안을 상담하고 싶습니다.', '현재 운동 루틴에서 근력운동을 늘리시고, 균형잡힌 식사와 충분한 단백질 섭취를 권장드립니다. 절대 굶지 마세요.', 'FINISHED', '2026-09-02 13:00:00', '2026-08-26 00:00:00'),
(26, 3, '2026-09-07', 'T2', '금연 프로그램 참여 관련 상담을 요청합니다.', '상담 미진행.', 'EXPIRED', '2026-09-07 15:00:00', '2026-08-20 00:00:00'),
(32, 2, '2026-09-08', 'T2', '장시간 근무로 인한 허리 통증 관리 방법을 알고 싶습니다.', '스트레칭을 자주 해주시고, 현재 상태로는 병원에서 진찰을 받아보시는 것이 좋겠습니다.', 'FINISHED', '2026-09-08 14:00:00', '2026-08-30 00:00:00'),
(26, 2, '2026-09-11', 'T1', '최근 혈압이 높아져 생활습관 점검이 필요합니다.', '저염식을 권장드리며, 병원에서 진료 받으신 후 꾸준한 약 복용을 권장합니다.', 'FINISHED', '2026-09-11 14:00:00', '2026-08-30 00:00:00'),
(21, 2, '2026-09-11', 'T6', '업무 스트레스와 수면 패턴에 대한 상담을 원합니다.', '취미 활동을 가져보세요. 수면 공간에서는 영상 시청을 자제하세요.', 'FINISHED', '2026-09-11 16:00:00', '2026-08-24 00:00:00'),

(16, NULL, '2026-09-14', 'T3', '체중 증가로 인한 건강 관리 방안을 상담하고 싶습니다.', NULL, 'RESERVED', NULL, '2026-08-25 00:00:00'),
(10, NULL, '2026-09-14', 'T4', '업무 스트레스와 수면 패턴에 대한 상담을 원합니다.', NULL, 'RESERVED', NULL, '2026-08-10 00:00:00'),
(4, NULL, '2026-09-17', 'T2', '장시간 근무로 인한 허리 통증 관리 방법을 알고 싶습니다.', NULL, 'RESERVED', NULL, '2026-08-16 00:00:00'),
(24, NULL, '2026-09-18', 'T6', '금연 프로그램 참여 관련 상담을 요청합니다.', NULL, 'RESERVED', NULL, '2026-08-09 00:00:00'),
(3, NULL, '2026-09-19', 'T3', '업무 관련 정서적 어려움에 대한 상담을 원합니다.', NULL, 'RESERVED', NULL, '2026-08-24 00:00:00'),

(15, NULL, '2026-09-22', 'T1', '수면 장애 및 불면증 관련 상담', NULL, 'RESERVED', NULL, '2026-09-01 00:00:00'),
(18, NULL, '2026-09-25', 'T4', '만성 피로 해소법 문의', NULL, 'RESERVED', NULL, '2026-09-02 00:00:00'),

(8, NULL, '2026-10-01', 'T2', '환절기 건강 관리 상담', NULL, 'RESERVED', NULL, '2026-09-05 00:00:00'),
(22, NULL, '2026-10-06', 'T3', '근골격계 질환 예방 문의', NULL, 'RESERVED', NULL, '2026-09-06 00:00:00');
