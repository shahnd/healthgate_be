...
public class Consultation {
	...
	private Long consultationsId;		// consultations_id	상담예약번호(ID)
	...
	private Date scheduledDate;			// scheduled_date	예약일자(NN, DATE)
	...
	@Column(name="CONSULTATION_AT", columnDefinition="TIMESTAMP")
	private LocalDateTime consultationAt;		// requested_at	일지작성일시(CURRENT_TIMESTAMP)
